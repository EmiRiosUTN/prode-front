...
export default function CompanyLayout({ children }: { children: ReactNode }) {
    ...
    const navItems = [
        { label: 'Prodes', href: '/company/prodes', icon: Trophy },
        { label: 'Empleados', href: '/company/employees', icon: Users },
        { label: 'Áreas', href: '/company/areas', icon: Building2 },
        { label: 'Configuración', href: '/company/config', icon: Settings },
    ];
